...
function content_5e36eb45b884c9_11922642 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE HTML>
<html lang="pl">
<head>
...
?>
  ...
  <center>  <h2> Zgłaszanie usterki</h> </center>
    ...
    <form action="functions/zloz-reklamacje.php?<?php echo '<?php ';?>
echo $string_pom <?php echo '?>';?>
" method="post">
